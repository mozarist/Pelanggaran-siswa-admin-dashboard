                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nickname</th>
        ...
        ?>
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?=$hsl['username']?></p>
                      </td>
                      ...
                      <a href="edit_user.php?id_user=<?= $hsl['id_user']?>" class="btn btn-success btn-sm">Edit</a>
