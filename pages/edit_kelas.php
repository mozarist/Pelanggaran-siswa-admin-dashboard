...
//sql
$data_kelas = "select * from tbl_kelas where id_kelas = '$id_kelas'";

//eksekusi
$go = mysqli_query($koneksi, $data_kelas);
...
if (isset($_POST['go'])) {
    ...
    //query
    $update = "update tbl_kelas set nama_kelas='$nama_kelas' where id_kelas=$id_kelas";
        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" value="<?=$ambil_data['nama_kelas']?>" name="nama_kelas" required>
            </div>
