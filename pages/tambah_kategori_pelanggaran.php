...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  $sql = "insert into tbl_kategori_pelanggaran (nama_pelanggaran, poin) values('$nama_pelanggaran', '$poin')";
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Tambah Jenis Pelanggaran</h6>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive px-4">
              <form action="" method="POST">
            <div class="form-group">
                <label for="example-text-input" class="form-control-label">Nama Pelanggaran</label>
                <input class="form-control" type="text" value="" name="nama_pelanggaran" required>
            </div>
            <div class="form-group">
                <label for="example-text-input" class="form-control-label">poin</label>
                <input class="form-control" type="text" value="" name="poin" required>
            </div>
