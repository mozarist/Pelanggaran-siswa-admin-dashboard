...
if (isset($_POST['go'])) {
    ...
    //query         
    $update = "update tbl_siswa set nis='$nis', nama='$nama', kelas='$kelas' where id_siswa=$id_siswa";
        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" value="<?=$ambil_data['nis']?>" name="nis" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" value="<?=$ambil_data['kelas']?>" name="kelas" required>
            </div>
