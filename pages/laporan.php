                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Detail Pelanggaran</th>
                    </tr>
                  </thead>
                  <?php
        $no = 1;
        $sql = "SELECT tbl_siswa.nama, tbl_siswa.kelas, SUM(tbl_kategori_pelanggaran.poin) AS total_poin, tbl_siswa.id_siswa
        ...
        ?>
                  <tbody>
                    <tr>
                      ...
                      <a href="detail_laporan.php?id_siswa=<?= $hsl['id_siswa']?>" class="btn btn-success btn-sm">Lihat Detail</a>
                      </td>
                    </tr>
                  </tbody>
                  <?php
