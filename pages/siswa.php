        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-1">
              <h6>Daftar Siswa</h6>
              <a href="tambah_siswa.php" class="btn btn-primary btn-sm">Tambah Siswa</a>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive px-4">
                <table class="table align-items-center mb-0">
                  ...
                  <?php
        $no = 1;
        $sql = "select * from tbl_siswa order by id_siswa asc";
        ...
        ?>
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?=$hsl['nis']?></p>
                      </td>
                      ...
                      <a href="edit_siswa.php?id_siswa=<?= $hsl['id_siswa']?>" class="btn btn-success btn-sm">Edit</a>
